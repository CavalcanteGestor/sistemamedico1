  ...
  const loadRoom = async () => {
    try {
      ...
      toast({
        ...
        description: error.message || 'Não foi possível carregar os dados da sala',
        variant: 'destructive',
      })
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: error.message || 'Não foi possível atualizar a sala.',
        variant: 'destructive',
      })
    } finally {
      setLoading(false)
    ...
    return (
      <div className="flex items-center justify-center h-96">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-muted-foreground font-medium">Carregando sala...</p>
        </div>
      </div>
    )
  }
